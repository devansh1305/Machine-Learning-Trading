...
class DTLearner:
    ...
    def constructTree(self, X, y):
        ...
        L_index = X[:, best_feature] <= best_threshold
        R_index = X[:, best_feature] > best_threshold
        X_L = X[L_index]
        y_L = y[L_index]
        X_R = X[R_index]
        y_R = y[R_index]
        ...
        return {"feature": best_feature, "threshold": best_threshold, "L": L_subtree, "R": R_subtree}
